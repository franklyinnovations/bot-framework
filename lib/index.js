...
var ChatBot = (function () {
    ...
    ChatBot.prototype.addIntent = function (newIntent) {
    ...
    ChatBot.prototype.addSkill = function (newSkill) {
    ...
    ChatBot.prototype.getTopics = function () {
...
function baseBotTextNLP(text) {
    var compacted = classifier_1.runThroughClassifiers(text, this.classifiers, true);
